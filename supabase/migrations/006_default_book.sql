...
declare
  ...
  v_slides jsonb := $book$[
  {
    ...
    "props": {
      ...
      "subtitle": "Un réseau de 2 000 médecins en Île-de-France. Une communauté engagée. Un parcours partenaire pensé pour votre impact.",
      ...
      "items": [
        {
          ...
          "description": "Manifesto, bureau & KOLs",
          "range": "Slides 03 – 05"
        },
        {
          "chapter": "02",
        ...
        },
        {
          ...
          "description": "Events mensuels et The Big Event",
          "range": "Slides 09 – 10"
        },
        {
          "chapter": "04",
          "title": "Plateforme & partenaires",
          "description": "Nos outils et notre communauté",
          "range": "Slides 11 – 12"
        },
        {
          "chapter": "05",
          "title": "Besoins & engagement",
          "description": "Budget, charte et contact",
          "range": "Slides 13 – 15"
        }
      ]
    }
      ...
      "benefits": [
        {
          ...
          "arrow": "Nos adhérents sont précisément dans la période de vie où ils souscrivent le plus de contrats et changent le plus de prestataires."
        },
        {
          "num": "02",
          ...
          "arrow": "Nos partenaires bénéficient d'un accès direct à une communauté déjà engagée et identifiée."
        },
        {
          "num": "03",
          "title": "Une recommandation vaut plus qu'une publicité",
          "body": "Un partenariat avec Générations Médecins place votre marque dans un environnement de confiance plutôt qu'une logique publicitaire.",
          "arrow": "Taux de conversion significativement supérieurs lorsque la mise en relation passe par une organisation professionnelle reconnue."
        },
        {
          "num": "04",
          ...
          "arrow": "L'objectif n'est pas la visibilité mais la génération de contacts et de nouveaux clients."
        }
      ],
      "closing": "Nous ne proposons pas que de la visibilité. Nous proposons un accès privilégié à plusieurs centaines de jeunes médecins au moment précis où ils choisissent leur banque, leur assureur, leur prévoyance et leurs partenaires professionnels."
    }
  },
  {
    "type": "audience",
    "props": {
      ...
      "channels": [
        ...
        },
        {
          ...
          "value": "360 / an",
          "caption": "30 participants × 12 soirées"
        },
        {
      ...
      "pillars": [
        {
          ...
          "body": "Petites annonces, décryptages d'actualité, contenus pratiques pour la vie professionnelle des médecins franciliens.",
          "tags": [
        ...
        },
        {
          ...
          "body": "Soirées en petit comité, format afterwork qualitatif, vraie proximité — les médecins viennent, échangent, se reconnaissent.",
          "tags": [
            "12 / an",
            "30 participants"
          ]
  ...
  },
  {
    ...
    "props": {
      ...
      "themes": [
        ...
        {
          "title": "Formats",
          "body": "Tables rondes • Interventions • Ateliers • Intervenant extérieur"
        }
      ]
    }
  },
  ...
  },
  {
    ...
    "props": {
      ...
      "subtitle": "Budget annuel global pour déployer l'ensemble du programme 2026 — événements, plateforme, communication.",
      "items": [
        {
          "label": "Events mensuels",
          "detail": "2 750 € × 12 événements",
          "amount": 33000
        },
        {
